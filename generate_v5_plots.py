...
def plot_dataset_dist():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "v5_dataset_dist.pdf"), dpi=300, bbox_inches='tight')
    plt.close()
...
def plot_training_loss():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "v5_training_loss.pdf"), dpi=300, bbox_inches='tight')
    plt.close()
...
def plot_phenotype_shift():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, "v5_phenotype_shift.pdf"), dpi=300, bbox_inches='tight')
    plt.close()
