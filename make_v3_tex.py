...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{v3_dataset_dist.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{v3_phenotype_shift.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{v3_training_loss.pdf}
...
\end{document}
"""
with open("out/v3_cardio-sahayak_preprint.tex", "w") as f:
    f.write(content)
